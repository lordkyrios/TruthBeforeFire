(function(sttc) {
    ...
    */
    ...
    function wd() {
        return xa && Aa ? Aa.mobile : !xd() && (r("iPod") || r("iPhone") || r("Android") || r("IEMobile"))
    }
    ...
    */
        ...
        J(a, b, c, d, e) {
            ...
            try {
                ...
                if (!(n = p)) {
                    ...
                    for (let V = 0, Pg = k.length - 1; V <= Pg; ++V) k[V].depth = Pg - V;
                    l = q;
                ...
                w = null;
                const Lk = p.length && p[Fe].url;
                dd.depth !== 0 && Lk && (w = p[Fe]);
                f = new Ce(dd, w);
                if (f.i) {
                    p = cb;
                    var t = f.i.url || "";
    ...
    var Xh = new P(1359),
        ...
        pi = new O(45709472),
        qi = new O(626390500),
        ri = new O(768003785, !0),
        si = new Wh(635821288, ["29_18", "30_19"]),
        ti = new Wh(683929765),
        ui = new O(506914611),
        vi = new P(717888910, .5423),
        wi = new P(9604, .5423),
        xi = new P(643258048, .1542),
        yi = new P(9601, .1542),
        zi = new P(643258049, .16),
        Ai = new P(9602, .16),
        Bi = new P(717888911, .7),
        Ci = new P(9605, .5799),
        Di = new P(717888912, .5849),
        Ei = new P(9606, .65),
        Fi = new P(748662193, 4),
        Gi = new P(9603, 4),
        Hi = new O(711741274),
        Ii = new O(788556408),
        Ji = new O(788558947),
    ...
    function Pi(a, b) {
        ...
        switch (b) {
            case 0:
                return {
                    init: Ri(a.previousSibling, c),
                    ia: e => Ri(e.previousSibling, c),
                    oa: 0
                };
            case 2:
                return {
                    init: Ri(a.lastChild, c),
                    ia: e => Ri(e.previousSibling, c),
                    oa: 0
                };
            case 3:
                return {
                    init: Ri(a.nextSibling, d),
                    ia: e => Ri(e.nextSibling, d),
                    oa: 3
                };
            case 1:
                return {
                    init: Ri(a.firstChild, d),
                    ia: e => Ri(e.nextSibling, d),
                    oa: 3
                }
        }
    ...
    function S(a) {
        return Ui(a).clientWidth ? ? void 0
    };
    ...
    function aj(a, b, c, d) {
        const e = $i(b, c, a, R(ei), d);
        e !== !0 ? a = e : d.google_full_width_responsive === "true" || Vi(c, b) ? (b = S(b), a = b - a, a = b && a >= 0 ? !0 : b ? a < -10 ? 11 : a < 0 ? 14 : 12 : 10) : a = 9;
        return a
    }
    ...
    function gj(a, b) {
        const c = ve(a) === 0;
        return b && c ? Math.max(250, 2 * Ui(a).clientHeight / 3) : 250
    }
    ...
    function kj(a, b) {
        return Yi(a, b) < Ui(b).clientHeight - 100
    }
    ...
    function mj(a, b) {
        ...
        if (c) return c;
        c = Infinity;
        do(d = b.style && Xd(b.style.height)) && (c = Math.min(c, d)), (d = fj(b, a, "maxHeight")) && (c = Math.min(c, d)); while (b.parentElement && (b = b.parentElement) && b.tagName !== "HTML");
        return c
    };
    var nj = {
        google_ad_channel: !0,
    ...
    function Rj(a) {
        ...
        } else b = b ? new Lj(b, Tc(a, 2, tc), Tc(a, 5, tc), Sj(Yc(a, 6))) : null;
        return b
    }
    const Tj = {
        1: 1,
    ...
    function Zj(a, b) {
        ...
        b.forEach(e => {
            if (Wc(e, uj, 1, xj)) {
                ...
                D(e, Rh, 3) && Ph(D(e, Rh, 3)) && (f = ak(a, Ph(D(e, Rh, 3)))) && c.set(ma(f), Qh(D(e, Rh, 3)))
            } else Wc(e, vj, 2, xj) ? bk(a, Wc(e, vj, 2, xj), c) : Wc(e, tj, 3, xj) && ck(a, Wc(e, tj, 3, xj), d)
        });
        return new dk(c, d)
    }
    var dk = class {
    ...
    const bk = (a, b, c) => {
            D(b, Rh, 2) ? (b = D(b, Rh, 2), (a = ak(a, Ph(b))) && c.set(ma(a), Qh(b))) : D(b, Bh, 1) && (a = ek(a, D(b, Bh, 1))) && a.forEach(d => {
                d = ma(d);
                c.set(d, 1);
                c.set(d, 4);
                c.set(d, 2);
        ...
        ck = (a, b, c) => {
            D(b, Bh, 1) && (a = ek(a, D(b, Bh, 1))) && a.forEach(d => {
                c.add(ma(d))
            })
        },
    ...
    function rk(a) {
        ...
        q.google_measure_js_timing || Oe(qk)
    }(function(a, b, c = !0) {
        ({
            Fb: kk,
            ub: ok
        ...
        nk = a || new eh;
        dh(nk, ok);
        lk = b || new yg(2, hg(), 1E3);
        pk = new mk(c);
        q.document.readyState === "complete" ? rk() : qk.g && ie(q, "load", () => {
            rk()
        })
    })();
    ...
    function wk(a, b, c = .01) {
        const d = L(ch).g();
        !b.eid && d.length && (b.eid = d.toString());
        $e(nk, a, b, !0, c)
    }

    function xk(a, b, c = kk, d, e) {
        return pk.J(a, b, c, d, e)
    }

    function yk(a, b, c = kk, d, e) {
        return (xe(b) ? b.msg || Ae(b.error) : Ae(b)).indexOf("TagError") === 0 ? ((xe(b) ? b.error : b).pbr = !0, !1) : xk(a, b, c, d, e)
    }
    ...
    function Ik(a) {
        return !!a.nextSibling || !!a.parentNode && Ik(a.parentNode)
    };
    ...
    function Qk(a) {
        return Tk(a) || U(a, "div[id^=div-gpt-ad]")
    }
    ...
    function Pk(a) {
        return Qk(a).concat(U(a, "iframe[id^=google_ads_iframe]"))
    }
    ...
    function Vk(a, b) {
        ...
        b: {
            ...
            let ja = [].concat(...Nk(e), ...U(e, "body ins.adsbygoogle"));f = [];
            for (const [Sa, Ta] of [
                    [h.nc,
                        k
                    ],
                    ...
                    [h.qc, z],
                    [h.yb, F]
                ]) Sa === !1 ? f = f.concat(Ta) : ja = ja.concat(Ta);h = Uk(ja);f = Uk(f);h = h.slice(0);
            for (p of f)
                for (f = 0; f < h.length; f++)(p.contains(h[f]) || h[f].contains(p)) && h.splice(f, 1);
            var p = h;e = Ui(e).clientHeight;
        ...
        for (g = 0; g < c.length; g++) {
            ...
            if (n ||
                Yc(h, 8) !== 1 || !Xk(h, d)) p = null;
            else {
                p.i++;
                if (k = Yk(p, h, k, d)) n = Vj(p.g), n.numAutoAdsPlaced || (n.numAutoAdsPlaced = 0), (l = !D(h, Bh, 1)) || (h = D(h, Bh, 1), l = Tc(h, 5) == null), l || (n.numPostPlacementsPlaced ? n.numPostPlacementsPlaced++ : n.numPostPlacementsPlaced = 1), n.placed == null && (n.placed = []), n.numAutoAdsPlaced++, n.placed.push({
                    index: f,
                    element: k.ga
                }), re(7, [!1, p.i, !0]);
                p = k
    ...
    function Yk(a, b, c, d) {
        if (!Xk(b, d) || Rb(y(b, 8)) != 1) return null;
        d = D(b, Bh, 1);
        if (!d) return null;
        d = Rj(d);
        if (!d) return null;
        ...
        if (!(f = e == null)) {
            a: {
                ...
                switch (e) {
                    ...
                    case 2:
                        var g = d.lastChild;
                        f = Gk(g ? g.nodeType == 1 ? g : Hk(g) : null, f);
                        break a
                }
                f = !1
            }
            if (c = !f && !(!c && e == 2 && !Ik(d))) c = e == 1 || e == 2 ? d : d.parentNode,
        ...
        if (!c) {
            ...
            a: switch (g) {
                case 1:
                    f = Ck(d.previousElementSibling) || Ek(d);
                    break a;
                case 4:
                    f = Ck(d) || Ek(d.nextElementSibling);
                    break a;
                case 2:
                    f = Ek(d.firstElementChild);
                    break a;
                case 3:
                    f = Ck(d.lastElementChild);
                    break a;
                default:
    ...
    var $k = class {
        constructor(a, b, c, d, e) {
            ...
            this.j = c;
            this.A = e || null;
            (this.F = d) ? (a = a.document, d = E(d, wj, 5, C()), d = Zj(a, d)) : d = Zj(a.document, []);
            this.B = d;
            this.D = new Fk;
            this.i = 0;
            this.u = !1
    ...
    function cl() {
        ...
        return b != null && typeof b == "object" && b.S != null && typeof b.S == "object" ? dl = b : a.google_persistent_state_async = dl = new el
    }

    function fl(a) {
        return gl[a] || `google_ps_${a}`
    }
    ...
    jl.prototype.set = function(a, b, c) {
        let d, e, f, g = !1,
            h;
    ...
    nl.prototype[fa(Symbol, "dispose")] = function() {
        this.dispose()
    };
    ...
    function sl(a, b, c, d) {
        c || (c = () => {});
        var e = a.j;
        typeof e.__tcfapi === "function" ? (a = e.__tcfapi, a(b, 2, c, d)) : rl(a) ? (tl(a), e = ++a.T, a.B[e] = c, a.g && a.g.postMessage({
            __tcfapiCall: {
                command: b,
                version: 2,
                callId: e,
        ...
        addEventListener(a) {
            ...
            const e = (f, g) => {
                ...
                f ? (b = f, b.internalErrorState =
                    pl(b), b.internalBlockOnErrors = this.F, g && b.internalErrorState === 0 || (b.tcString = "tcunavailable", g || (b.internalErrorState = 3))) : (b.tcString = "tcunavailable", b.internalErrorState = 3);
                a(b)
            };
            try {
    ...
    var zl = ({
            ...
            b.g != null || b.i.message != "tcunav" ? d(b) : wl(a, c).then(g => g.map(xl)).then(g => g.map(h => yl(a, h))).then(d)
        },
        vl = ({
            l: a,
            aa: b,
            ...
            b = cl();
            return (b = il(b, 24)) ? yl(a, xl(b)) : uh(Error("tcunav"))
        };
    ...
    function yl(a, b) {
        return (a = kl(b, a)) ? sh(a) : uh(Error("unav"))
    };
            ...
            try {
                switch (this.j.document.readyState) {
                    ...
                    case "interactive":
                        ...
                        break;
                    default:
                        Vk(this.g, !1) ? Hl(this) : this.j.setTimeout(ra(this.u, this), 100)
                }
            } catch (a) {
                Hl(this, a)
            }
    ...
    function Xl(a) {
        const b = W(a, 16);
        return !!W(a, 1) === !0 ? (a = Vl(a), a.forEach(c => {
    ...
    var $l = (a, b) => {
        try {
            ...
            c.specialFeatureOptins = Zl(Wl(d, 12, Rl), Rl);
            c.purpose = {
                consents: Zl(Wl(d, 24, Ql), Ql),
                legitimateInterests: Zl(Wl(d, 24, Ql), Ql)
            };
            c.purposeOneTreatment = !!W(d, 1);
            c.publisherCC = String.fromCharCode(Pl + W(d, 6)) + String.fromCharCode(Pl +
                W(d, 6));
            c.vendor = {
                consents: Zl(Xl(d), null),
                legitimateInterests: Zl(Xl(d), null)
            };
            return c
        } catch (d) {
            return null
    ...
    function em(a) {
        ...
        return b ? D(b, cm, 4) || null : null
    }

    function fm(a) {
        a = (new jl(a)).get("FCCDCF", "");
        if (a)
            if (a.startsWith("%")) try {
    ...
    Ad(ih).map(a => Number(a));
    Ad(jh).map(a => Number(a));
    ...
    function om(a, b) {
        ...
        function h(m) {
            const p = [];
            let w = 0;
            for (let t = 0; t < m.length / 2; t++) p.push(Ll(m.slice(w, w + 2))), w += 2;
            return p
        }
                ...
                if (c && (c > 2.2 || c <= 1)) d(null, !1);
                    ...
                    switch (b) {
                        ...
                        case "addEventListener":
                            b = f.push(d) - 1;
                            a.tcString ?
                                (e = $l(a.tcString, c), e.addtlConsent = a.g != null ? a.g : void 0, e.cmpStatus = "loaded", e.eventStatus = "tcloaded", b != null && (e.listenerId = b), b = e) : b = null;
                            d(b, !0);
                            break;
    ...
    function wm(a) {
        if (!a ? .g() || I(a, 1).length === 0 || E(a, mm, 2, C()).length === 0) return null;
        const b = I(a, 1);
        let c;
        try {
            var d = Nl(b.split("~")[0]);
    ...
    var tm = class {
        constructor(a) {
            ...
            try {
                ...
                c = null
            }(a = c) ? (c = D(a, bm, 5) || null, a = E(a, am, 7, C()), a = ym(a ? ? []), c = {
                Qa: c,
                Sa: a
            }) : c = {
                Qa: null,
            ...
            this.tcString = (c = em(b.document)) && v(y(c, 1)) != null ? I(c, 1) : null;
            this.g = (b = em(b.document)) && v(y(b,
                2)) != null ? I(b, 2) : null
        }
    };
    const zm = {
    ...
    function Fm(a, b) {
        ...
        return b.find(e => {
            ...
            vc(e, sj, 7) ? (e = D(e, sj, 7), e = Yc(e, 2)) : e = 2;
    ...
    function Om(a, b, c, d = "") {
        return b === 1 && c && (Pm(a, d, c) ? .F() ? ? !1) ? !0 : Qm(a, d, e => La(E(e, ld, 2, C()), f => Yc(f, 1) === b), !!D(c, Rm, 26) ? .g())
    }

    function Sm(a, b) {
        const c = od(M) || M;
        return Tm(c, a) ? !0 : Qm(M, "", d => La(xc(d, 3, Rb, C()), e => e === a), b)
    }
    ...
    function Qm(a, b, c, d) {
        ...
        const e = Um(a, d);
        b && (b = we(String(b)));
        return zd(e, (f, g) => Object.prototype.hasOwnProperty.call(e, g) && (!b || b === g) && c(f))
    }
    ...
    function Xm(a, b) {
        const c = [];
        a = Lm(q) ? Nm : (a = Pm(q, a, b) ? .T()) ? [...xc(a, 3, Rb, C())] : Nm;
    ...
    function dn(a) {
        ...
        return (a = (a = c) ? (qm(D(a, rj, 3) ? .g()) ? ? 0) > Date.now() ? a : null : null) ? sh(a) : uh(Error("invlocst"))
    }

    function fn(a) {
        if (Lm(a.l) && !G(a.g, 22)) return uh(Error("invtag"));
        if (a = (a = Pm(a.l, a.j, a.g) ? .H()) && E(a, Th, 1, C()).length > 0 ? a : null) {
            var b = new Ej;
            var c = E(a, Th, 1, C());
            b = Qc(b, 1, c);
            a = E(a, yj, 2, C());
    ...
    function un(a) {
        a.google_reactive_ads_global_state ? (a.google_reactive_ads_global_state.sideRailProcessedFixedElements == null && (a.google_reactive_ads_global_state.sideRailProcessedFixedElements = new Set), a.google_reactive_ads_global_state.sideRailAvailableSpace == null && (a.google_reactive_ads_global_state.sideRailAvailableSpace = new Map), a.google_reactive_ads_global_state.sideRailPlasParam == null && (a.google_reactive_ads_global_state.sideRailPlasParam = new Map), a.google_reactive_ads_global_state.sideRailMutationCallbacks ==
            null && (a.google_reactive_ads_global_state.sideRailMutationCallbacks = []), a.google_reactive_ads_global_state.adIntentsPageState == null && (a.google_reactive_ads_global_state.adIntentsPageState = new tn)) : a.google_reactive_ads_global_state = new vn;
    ...
    var vn = class {
            constructor() {
                ...
                this.adIntentsPageState = new tn
            }
        },
        wn = class {
            constructor() {
    ...
    function xn(a) {
        ...
        Td(a, (d, e) => {
            nj[e] && e !== "google_ad_client" && (c[e] = d)
        });
        c.google_pgb_reactive = 7;
        c.asro = Q(ui);
        c.aihb = Q(qi);
        c.aifxl = ln(L(ae).g(si.g, si.defaultValue));
        R(xi) && (c.aiapm = R(xi));
        R(zi) && (c.aiapmi =
            R(zi));
        R(vi) && (c.aiact = R(vi));
    ...
    function Bn(a, b, c, d) {
        ...
        vc(c, Dj, 24) && (d = Wj(a), d.availableAbg = !0, d.ablationFromStorage = !!D(c, Dj, 24) ? .g() ? .g());
        ...
        D(c, qj, 15) ? .g() && (X(a).enable_overlap_observer = !0);
        D(c, Dj, 24) ? .g() ? .g() && (Wj(a).ablatingThisPageview = !0, Im(a));
        re(3, [x(c)]);
    ...
    function Dn(a, b) {
        return {
            kxiJd: {
                VbBrq: Cn(a, b, "google_ad_public_floor"),
                hZGxt: Cn(a, b, "google_ad_private_floor")
            }
        }
    };
    ...
    function Yn(a, b, c = "") {
        M.google_sa_queue || (M.google_sa_queue = [], M.google_process_slots = uk(215, () => {
    ...
    function Zn(a) {
        const b = a.shift();
        typeof b === "function" && tk(216, b);
        a.length && q.setTimeout(uk(215, () => {
            Zn(a)
        }), 0)
    }
    ...
    function $n(a, b, c) {
        var d = M;
        b = G(c, 4) ? Q(Ni) ? Pm(d, a || Fn(d), c) ? b.ab : b.Za : b.Za : b.ab;
        a: {
            if (G(c, 4)) {
                if (a = a || Fn(d)) {
                    b: {
    ...
    function co(a, b, c) {
        ...
        Q(Mi) && (c.google_reactive_ad_format === 10 ? e = "interstitial" : c.google_reactive_ad_format === 11 && (e = "rewarded"));
        ...
        if (typeof c.google_reactive_sra_index !== "number" || !c.google_ad_unit_key) {
            e = [c.google_ad_slot,
                c.google_orig_ad_format || c.google_ad_format, c.google_ad_type, Q(Ji) ? c.google_ad_width : c.google_orig_ad_width || c.google_ad_width, Q(Ii) ? c.google_ad_height : c.google_orig_ad_height || c.google_ad_height
            ];
            d = [];
            f = 0;
    ...
    function Ao(a, b, c, d, e) {
        ...
        if (f === "in-article") {
            ...
            else if (a = $i(b, c, g, R(ci), e), a !== !0) e.gfwrnwer = a, a = g;
            else if (a = S(b))
    ...
    function Eo(a, b, c, d, e) {
        e.google_full_width_responsive === "false" ? c = {
            I: a,
            G: 1
        } : b === "autorelaxed" && e.google_full_width_responsive || Fo(b) || e.google_ad_resize ? (b = aj(a, c, d, e), c = b !== !0 ? {
            I: a,
            G: b
        } : {
            I: S(c) || a,
    ...
    function Go(a, b, c, d, e) {
        ...
        h = Io(b, p);
        var t;
        const z = (t = fj(d, c, "marginLeft")) ? `${t}px` : "",
            F = (t = fj(d, c, "marginRight")) ? `${t}px` : "";
        t = hj(d, c) || "";
    ...
    function Ho(a, b, c, d, e, f) {
        ...
        l = [ij(a), ho(b)];
        Q(ii) || l.push(jj(n, c, d, k));
        e.google_max_responsive_height != null && l.push(lj(e.google_max_responsive_height));
        n = [t => !t.A];
        if (h || k) h = mj(c, d), n.push(lj(h));
            ...
            a: if (f) {
                ...
                if (e.google_resizing_allowed ||
                    ...
                    do {
                        var z = fj(t, c, "height");
                        z && (F = Math.min(F, z));
                        (z = fj(t, c, "maxHeight")) && (F = Math.min(F, z))
    ...
    function Jo(a, b, c) {
        if (c === "auto") c = Math.min(1200, S(a)), b = b / c <= .25 ? 4 : 3;
            ...
            b = 0;
            for (const d in Si) c.indexOf(d) !== -1 && (b |= Si[d])
        }
        return b
    }

    function Ko(a, b, c, d, e) {
        const f = e.google_ad_height || fj(c, b, "height");
        b = Ao(a, b, c, f, e).size();
    ...
    function Lo(a, b, c, d, e) {
        var f;
        (f = S(b)) ? S(b) < 488 ? b.innerHeight >= b.innerWidth ? (e.google_full_width_responsive_allowed = !0, ej(b, c), f = {
            I: f,
            G: !0
        }) : f = {
            I: a,
    ...
    function Oo(a, b, c, d, e = !1) {
        var f = b.offsetWidth || (c.google_ad_resize || e) && fj(b, d, "width") || c.google_ad_width || 0;
        ...
        f = od(window) || window;
        mn(f.location, "google_responsive_dummy_ad") && (Na([1, 2, 3, 4, 5, 6, 7, 8], e.D) || e.g === 1) && e.g !== 2 && (f = JSON.stringify({
            googMsgType: "adpnt",
            key_value: [{
                key: "qid",
                value: "DUMMY_AD"
    ...
    function Po(a, b, c, d, e) {
        const f = d.google_ad_height || fj(c, e, "height") || 0;
        switch (a) {
            case 5:
                const {
                    I: g,
                    G: h
                } = tk(247, () => Eo(b, d.google_ad_format, e, c, d));
                h === !0 && b !== g && ej(e, c);
    ...
    function Vo(a, b, c, d) {
        ...
        if (Q(ai) ||
            S(c) < 488) {
            f = od(c) || c;
            g = a.offsetWidth || fj(a, c, "width") || b.google_ad_width || 0;
            e = b.google_ad_client;
            if (d = mn(f.location, "google_responsive_slot_preview") || Om(f, 1, d, e)) b: if (b.google_reactive_ad_format || b.google_ad_resize || Mo(b) || Xi(a, b)) d = !1;
                else {
                    ...
                    if (!Q(ji) && (d = R(di), d = $i(c, a, g, d, b), d !== !0)) {
                        b.gfwrnwer = d;
                        d = !1;
                        break b
                    }
        ...
        if (g = Mo(b)) Oo(g, a, b, c, d);
            ...
            if (Xi(a, b)) {
                if (d = Rd(a, c)) a.style.width = d.width, a.style.height = d.height, Wi(d, b);
            ...
            c.location && c.location.hash === "#gfwmrp" || b.google_responsive_auto_format === 12 && b.google_full_width_responsive === "true" ? Oo(10, a, b, c, !1) : Math.random() < .01 && b.google_responsive_auto_format ===
                12 && (a = aj(a.offsetWidth || parseInt(a.style.width, 10) || b.google_ad_width, c, a, b), a !== !0 ? (b.efwr = !1, b.gfwrnwer = a) : b.efwr = !0)
        }
    };
    ...
    function mp(a) {
        ...
        wg(a.j, () => {
            ...
            var e = Zo(c);
            d = Qc(d, 1, e);
            e = hd(yf(xf(new zf, S(c)), Ui(c).clientHeight));
            d = Oc(d, 2, e);
            c = hd(yf(xf(new zf, Ui(c).scrollWidth), Ui(c).scrollHeight));
            c = Oc(d, 3, c);
            c = hd(c);
            Oc(b, 4, c);
            c = a.g;
    ...
    async function np(a) {
        ...
        if (b.i && !b.state.le.includes(1)) {
            ...
            var d = new Df;
            a = Ec(d, 5, Mb(a), !1);
            d = yf(xf(new zf, Ui(b.l).scrollWidth), Ui(b.l).scrollHeight);
            a = Oc(a, 2, d);
            d = yf(xf(new zf, S(b.l)), Ui(b.l).clientHeight);
            a = Oc(a, 1, d);
    ...
    var kp = class {
        ...
        get u() {
            return tk(1178, () => id(Gf, hc(this.state.psi || []))) || new Gf
        }
        get A() {
            return tk(1227, () => id(If, hc(this.state.cc || []))) || new If
        }
    };
    ...
    function Up({
        ...
        mb: d = up(),
        nb: e = 0,
        M: f = new Dg(qm(D(a, Ep, 5) ? .g()) ? ? 0, qm(D(a, Ep, 5) ? .j()) ? ? 0, D(a, Ep, 5) ? .u() ? ? !1),
    ...
    function Yp(a, b, c) {
        ...
        if (d.plle) Vp(1, up(a));
            ...
            Xp(10, a);
            a = od(a) || a;
            mn(a.location, "google_mc_lab") && L(ch).i(44738307)
        }
    };
    ...
    function qq(a) {
        a = a.id;
        return a != null && (pq().has(a) || a.startsWith("google_ads_iframe_") || a.startsWith("aswift"))
    }
    ...
    function xq() {
        const a = Array.from(document.getElementsByTagName("iframe")).filter(qq),
            b = [...pq()].map(c => document.getElementById(c)).filter(c => c !== null);
        yq = window.scrollX;
        zq = window.scrollY;
        return Aq = [...a, ...b].map(c => c.getBoundingClientRect())
    }
        ...
        if (Q(Ki)) {
            ...
            if (!b.google_plmetrics && window.PerformanceObserver) {
                ...
                for (const c of b) b = {
                    type: c,
                    buffered: !0
                }, c === "event" && (b.durationThreshold = 40), Dq(a).observe(b);
                Eq(a)
            }
        }
    }
    ...
    function Fq(a, b) {
        const c = yq !== window.scrollX || zq !== window.scrollY ? [] : Aq,
            d = xq();
        for (const e of b.getEntries()) switch (b = e.entryType, b) {
            ...
            case "first-input":
                ...
                a.Da = !0;
                a.g.some(f => f.entries.some(g => e.duration === g.duration && e.startTime === g.startTime)) || Hq(a, e);
                break;
            case "longtask":
    ...
    function Dq(a) {
        a.M || (a.M = new PerformanceObserver(Pj(640, b => {
            Fq(a, b)
        })));
        return a.M
    }
    ...
    function Eq(a) {
        const b = Pj(641, () => {
                ...
                (d.prerendering ? 3 : {
                    ...
                    unloaded: 5,
                    "": 0
                }[d.visibilityState || d.webkitVisibilityState || d.mozVisibilityState || ""] ? ? 0) === 2 && Iq(a)
            }),
            c = Pj(641, () => void Iq(a));
    ...
    function Iq(a) {
        if (!a.Ja) {
            ...
            window.LayoutShift && (b += oq("cls", a.D), b += oq("mls", a.T), b += nq("nls", a.da), window.LayoutShiftAttribution && (b += oq("cas", a.A), b += nq("nas", a.Ia), b += oq("was", a.Na)), b += oq("wls", a.sa), b += oq("tls", a.Ma));
            window.LargestContentfulPaint && (b += nq("lcp", a.Ga), b += nq("lcps", a.Fa));
            window.PerformanceEventTiming && a.Da && (b += nq("fid", a.Ca));
            window.PerformanceLongTaskTiming && (b += nq("cbt", a.B),
                b += nq("mbt", a.H), b += nq("nlt", a.ra));
            let d = 0;
            ...
            b += `&${"top"}=${q===q.top?1:0}`;
            b += a.La ? `&${"qqid"}=${encodeURIComponent(a.La)}` : nq("pvsid", ce(q));
    ...
    function Gq(a, b, c, d) {
        if (!b.hadRecentInput) {
            ...
            a.da += 1;
            if (c = rq(b, c, d)) a.A += b.value, a.Ia++;
    ...
    function Oq(a) {
        return oj.test(a.className) && a.dataset.adsbygoogleStatus !== "done"
    }
    ...
    function Sq(a) {
        ...
        for (let d = 0, e = b[d]; d < b.length; e = b[++d]) {
            var c = e;
            if (Oq(c) && c.dataset.adsbygoogleStatus !== "reserved" && (!a || e.id === a)) return e
        }
        return null
    }
    ...
    function Wq(a, b) {
        ...
        f.abgtt = iq(Xq(a) || Fn(M), b, f.google_loader_used) || void 0;
        Pq(e, f, b, {
            kxiJd: {}
        });
        jp(g => {
    ...
    function Yq(a, b) {
        ...
        const c = () => {
            ...
            d = q.document;
        if (d.body || d.readyState === "complete" || d.readyState === "interactive") Wq(a, b);
        else {
            const e = vd(uk(191, c));
    ...
    function $q(a) {
        ...
        Td(a, (b, c) => {
            nj[c] || (delete a[c], b = c.replace("google", "data").replace(/_/g, "-"), q.console.warn(`AdSense head tag doesn't support ${b} attribute.`))
        })
    }
    ...
    function ar(a, b) {
        ...
        if (c) {
            ...
            if (d.head_tag_slot_vars) br(c);
                ...
                b = Ym(b) ? .j();
                e.google_adbreak_test || b ? cr(f, a) : mq("sc-cnf", () => {
                    cr(f, a)
                })
            }
        }
    ...
    function dr(a, b) {
        ...
        if (c) {
            ...
            X(window).head_tag_slot_vars = Bd(d);
            c = d;
            d = {
    ...
    function er() {
        ...
        if (a = a.document.querySelector('script[src*="/pagead/js/adsbygoogle.js?client="]:not([data-checked-head])') || a.document.querySelector('script[src*="/pagead/js/adsbygoogle_direct.js?client="]:not([data-checked-head])') || a.document.querySelector('script[src*="/pagead/js/adsbygoogle.js"][data-ad-client]:not([data-checked-head])') || a.document.querySelector('script[src*="/pagead/js/adsbygoogle_direct.js"][data-ad-client]:not([data-checked-head])'))
            if (a.setAttribute("data-checked-head", "true"),
                X(window).head_tag_slot_vars) br(a);
            else return jp(b => {
                b = Ff(b);
                Ec(b, 7, Mb(!0), !1)
            }), a
    ...
    function fr(a, b, c) {
        b = Ym(b) ? .j();
        a.google_adbreak_test || b ? cr(a, c) : mq("sc-cnf", () => {
            cr(a, c)
        })
    }
    ...
    function Zq(a, b, c, d) {
        ...
        var e = gr(a);
        if (e !== 0)
            if (d = Km(), d.first_slotcar_request_processing_time || (d.first_slotcar_request_processing_time = Date.now(), d.adsbygoogle_execution_start_time = hh), Kq == null) hr(a), Lq.push(a);
            else if (e === 3) {
            const f = Kq;
            tk(787, () => {
                f.handleAdConfig(a)
            })
        } else vk(730, Kq.handleAdBreak(a));
        else {
            hh = (new Date).getTime();
            Yn(c, d, Xq(a));
            ir();
            ...
            if (e) jp(f => {
                ...
                b.abgtt = iq(Xq(a) || Fn(M), d, b.google_loader_used) || void 0;
                e = kr(b, a);
                To(e,
                    b);
                ...
                Pq(e, b, d, a.clWLG ? .klgrb || Dn(a.params, e))
            }
        }
    }
    ...
    function kr(a, b) {
        ...
        if (c) b = Vq(), b.dataset.adsbygoogleStatus =
            "reserved", le.documentElement.appendChild(b);
        else if (b = b.element) {
            if (!Oq(b) && (b.id ? b = Sq(b.id) : b = null, !b)) throw new T("'element' has already been filled.");
            if (!("innerHTML" in b)) throw new T("'element' is not a good DOM element.");
        } else if (b = Sq(), !b) throw new T("All 'ins' elements in the DOM with class=adsbygoogle already have ads in them.");
        if (c) {
            c = M;
            try {
    ...
    function or(a) {
        typeof a === "function" && Q(pi) && mq("aevi", b => {
            try {
                a(b)
            } catch {
                console.log("onPaidEvent function call failed. The function should be in the form: (event: object) => void, please check for errors in the function you passed to iLAR.")
            }
        })
    }
    ...
    function cr(a, b) {
        ...
        b = sn(Nd(b.Ib, new Map(Object.entries(c)))).then(d => {
            Kq == null && (d.init(a), Kq = d, qr(d))
        });
        vk(723, b);
        b.finally(() => {
            Lq.length = 0;
    ...
    function qr(a) {
        for (const [c, d] of Mq) {
            var b = c;
            const e = d;
            e !== -1 && (q.clearTimeout(e), Mq.delete(b))
        }
        for (b = 0; b < Lq.length; b++) {
            if (Mq.has(b)) continue;
            const c = Lq[b],
                d = gr(c);
            tk(723, () => {
                d === 3 ? a.handleAdConfig(c) : d === 2 && vk(730, a.handleAdBreakBeforeReady(c))
            })
        }
    }
    ...
    (function(a, b, c, d = () => {}) {
        ...
        tk(166, () => {
            ...
            Yp(g, f, k);
            Q(Hi) && I(f, 29) && jq(g.document, lq(I(f, 29)));
            jp(l => {
                var m = H(l, 1) + 1;
                $c(l, 1, m);
            ...
            if (!Ea() || va(Ha(), 11) >= 0) {
                ...
                if (!k || !k.loaded) {
                    ...
                    if (k)
                        for (const l of ["requestNonPersonalizedAds", "pauseAdRequests", "onPaidEvent"]) k[l] !== void 0 && (n[l] = k[l]);
                    Tq(k, h, f);
                    g.adsbygoogle = n;
                    k && (n.onload = k.onload)
                }
