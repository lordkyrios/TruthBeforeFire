            ...
            return function(g, h, i, j) {
                ...
                (function() {
                    ...
                    var F = o.registerAsyncParamAllSettledListener,
                        ...
                        P = "global_config",
                        aa = 200;
                    o = ["InferredEvents", "Microdata", "AutomaticParameters", "EngagementData", "PageMetadata", "ScrollDepth"];
                    var Q = {
                            AutomaticSetup: o
                        },
                        R = {
                    ...
                    j.exports = function(a) {
                        ...
                        function $c() {
                            ...
                            for (var z = c.length - 1; z >= 0; z--) {
                                var m = c[z],
                                    A = m.getAttribute("itemtype");
                                if ("string" == typeof A && "" !== A) {
                                    for (var n = {}, B = m.querySelectorAll("[itemprop]"), o = 0; o < B.length; o++) {
                                        var C = B[o];
                                        if (!e.has(C)) {
                                            e.add(C);
                                            ...
                                            if ("string" == typeof p && "" !== p) {
                                                ...
                                                if (null != q && "" !== q) {
                                                    var r = n[p];
                                                    null != r && Tc(A, p) ? Array.isArray(r) ? n[p].push(q) : n[p] = [r, q] : (null == y.productID && ("productID" === p ? h = q : "sku" === p && (j = q)), null == y.productUrl && "url" === p && (y.productUrl = q), a && (null == y.automaticParameters.currency && "priceCurrency" === p && (y.automaticParameters.currency = q), null != k.id || "productID" !== p && "sku" !== p || (k.id = q), null == k.mpn && "mpn" === p && (k.mpn = q), null == k.gtin && (b ? ["gtin"] : Y).includes(p) && (k.gtin = q), null == k.item_price && "price" === p && Z(k, "item_price", hd(q, b)), null == k.availability && "availability" === p && (k.availability = kd(q))), n[p] = q)
                                                }
                                            }
                                        }
                                    }
                            ...
                            null != h ? y.productID = h : null != j && (y.productID = j), null == l.contents && (l.contents = []), l.contents.push(k), gd(y.automaticParameters, a, l.contents);
                            for (var s = [], D = [], t = 0; t < d.length; t++) {
                                for (var u = d[t], v = u.scope, w = u.schema, x = D.length - 1; x >= 0; x--) {
                                    if (D[x].scope.contains(v)) {
                                        D[x].schema.subscopes.push(w);
                                        break
                                    }
                                    D.pop()
                                }
                                0 === D.length && s.push(w), D.push({
                                    schema: w,
                                    scope: v
                                })
                            }
                            return {
                                extractedProperties: s,
                                productMetadata: y
                            }
                        }
                        ...
                        function cd() {
                            for (var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], b = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], c = arguments.length > 2 ? arguments[2] : void 0, d = {
                                ...
                                if (null != l && "" !== l) try {
                                    ...
                                    var o = JSON.parse(l.replace(/[\n\r\t]+/g, " "));
                                    Array.isArray(o) || (o = [o]);
                                    for (var m = function() {
                                            var f = o[p];
                                            b || (dd(o, $(f, ["mainentity"])), dd(o, $(f, ["@graph"])), dd(o, $(f, ["hasvariant"])));
                                            var g = fd(f),
                                                h = Jc.includes(g),
                                                i = {};
                                            if (h) {
