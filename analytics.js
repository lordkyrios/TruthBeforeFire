!(function() {
    ...
    function J(c, o, i) {
        ...
        a.open("POST", c, !0), a.setRequestHeader("Content-Type", "text/plain"), a.send(o), a.onreadystatechange = function() {
    ...
    function f(c) {
        try {
            ...
            if (i instanceof Error) J(T, JSON.stringify({
                message: i.message,
                stack: i.stack
            }));
            else {
    ...
    f(function() {
        ...
        function o(t, e) {
            if (/^localhost$|^127(\.[0-9]+){0,2}\.[0-9]+$|^\[::1?\]$/.test(y.hostname) || y.protocol === "file:") return c("localhost", e);
            if ((window._phantom || window.__nightmare || window.navigator.webdriver || window.Cypress) && !window.__web_analytics) return c(null, e);
            ...
            var s = {};
            s.n = t, s.u = y.href, u != null && (s.l = u), r != null && (s.d = r), n != null && (s.k = n), s.r = window.document.referrer || null, e && e.meta && (s.m = JSON.stringify(e.meta)), (e && e.props || m) && (s.p = JSON.stringify(b({}, v, e == null ? void 0 : e.props)));
            var R;
            try {
        ...
        D || (window.document.visibilityState === "prerender" ? window.document.addEventListener("visibilitychange", function() {
            ...
            f(function() {
                if (d == null) {
                    ...
                    t === "hidden" ? a("x-visibilitychange-hidden") : t === "visible" && a("x-visibilitychange-visible")
                }
            })
        ...
        if (window.MutationObserver != null) {
                ...
                Y = new MutationObserver(function(t) {
                    f(function() {
                        t.forEach(function(e) {
                            e.type === "childList" && p(e.addedNodes, function(n) {
                                n.nodeType === Node.ELEMENT_NODE && (z(n) ? L(n) : n.querySelectorAll != null && p(n.querySelectorAll("a"), L), j(n) ? O(n) : n.querySelectorAll != null && p(n.querySelectorAll("form"), O), Q(n) ? x(n) : n.querySelectorAll != null && p(n.querySelectorAll(U), x))
                            })
                        })
                    })
                });
            window.addEventListener("DOMContentLoaded", function() {
                f(function() {
                    p(document.querySelectorAll("a"), L), p(document.querySelectorAll("form"), O), p(document.querySelectorAll(U), x), Y.observe(document.body, {
                        childList: !0,
                        subtree: !0
                    })
                })
            ...
            var g = void 0,
                P = M + "-ready";
            typeof CustomEvent == "function" ? g = new CustomEvent(P, {
                detail: null,
                bubbles: !0,
                cancelable: !0
            }) : typeof document != "undefined" && document.createEvent && (g = document.createEvent("CustomEvent"), g.initCustomEvent(P, !0, !0, null)), g != null && typeof document != "undefined" && (document.dispatchEvent ? document.dispatchEvent(g) : "fireEvent" in document && document.fireEvent("on" + P, g))
        }
    })
})();